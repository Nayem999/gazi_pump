...
<div class="row g-3">
    ...
    <div class="col-12">
        <div class="form-check form-switch">
            ...
            <input type="checkbox" class="form-check-input" id="status" name="status" value="1" @checked(old('status', $driver->status ?? true))>
...
<div class="mt-4 d-flex gap-2">
    <button type="submit" class="btn btn-primary"><i class="ti ti-check me-1"></i>{{ isset($driver) ? 'Update Driver' : 'Create Driver' }}</button>
