...
class StoreCollectionEntryRequest extends FormRequest
{
    ...
    /**
     * The mobile app is expected to only ever offer dealers from GET
     * /dealers, which is already scoped to the executive's own territory —
     * this is the server-side backstop in case a tampered request skips
     * that.
     */
